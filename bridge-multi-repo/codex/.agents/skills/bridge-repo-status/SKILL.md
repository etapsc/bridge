---
name: Bridge Repo Status
description: Workspace status — per-repo state, branches, and coordination health. Invoke with $bridge-repo-status in your prompt.
---
...
```
HUMAN:
1. Verify the coordination health checks match your expectations
2. If drift detected: approve context.json update or investigate manually
3. If all clean: proceed with next slice work
```
