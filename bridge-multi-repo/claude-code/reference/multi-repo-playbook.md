...
tar -xzf bridge-multi-repo-claude-code.tar.gz
```
...
my-product/
  bridge-orchestrator/        <-- multi-repo pack (you are here)
    ...
    .claude/
      commands/
        bridge-cross-design.md
        bridge-cross-review.md
        bridge-cross-sync.md
        bridge-repo-status.md
      rules/
        multi-repo.md
    docs/
...
Open Claude Code in the orchestrator folder and run:
...
```
1. Open Claude Code in the orchestrator folder
...
| **Commands** | status, init-project, sync | cross-design, cross-review, cross-sync, repo-status |
